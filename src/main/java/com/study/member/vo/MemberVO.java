...
public class MemberVO {
    ...
    @ExcelColumn(headerName = "회원아이디")
    private String memId;                   /* 회원아이디 */
    @ExcelColumn(headerName = "회원비밀번호")
    private String memPass;                 /* 회원비밀번호 */
    @ExcelColumn(headerName = "회원이름")
    private String memName;                 /* 회원이름 */
    @ExcelColumn(headerName = "회원생년월일")
    ...
    public String getMemCategoryNm() {
        return memCategoryNm;
    }

    public void setMemCategoryNm(String memCategoryNm) {
        this.memCategoryNm = memCategoryNm;
    }
}