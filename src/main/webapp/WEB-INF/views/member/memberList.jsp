...
<div class="container">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <select id="id_searchType" name="searchType" class="form-control input-sm">
                            <option value="NM" ${search.searchType=='NM' ? "selected='selected'" :""} >회원명</option>
    ...
    <nav class="text-center">
        <ul class="pagination">
            ...
            <!-- 페이지 넘버링  -->
            <!-- 페이지 넘버링  -->
<%--            <li><a href="memberList.wow?curPage=6"  data-page="6" >6</a></li>--%>
<%--            <li><a href="memberList.wow?curPage=7"  data-page="7" >7</a></li>--%>
<%--            <li><a href="memberList.wow?curPage=8"  data-page="8" >8</a></li>--%>
<%--            <li class="active"><a href="#">9</a></li>--%>
<%--            <li><a href="memberList.wow?curPage=10"  data-page="10" >10</a></li>--%>
    ...
    <a href="/excel/memberList.wow" class="btn btn-default btn-sm" target="_blank" id="excelDown" > excelDown </a>
